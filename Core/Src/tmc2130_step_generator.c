...
uint8_t TMC_Get_Status(TMC2130_Controller_t *handle)
    ...
    status |=
	    (tmc_ramp_linear_get_mode(&handle->Step_Generator.ramp)
...
void TMC_Set_Actual_Position(TMC2130_Controller_t *handle,
